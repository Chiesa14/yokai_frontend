...
GetActivityByChapterId getActivityByChapterIdFromJson(String str) => GetActivityByChapterId.fromJson(json.decode(str));

String getActivityByChapterIdToJson(GetActivityByChapterId data) => json.encode(data.toJson());
...
class GetActivityByChapterId {
  ...
  factory GetActivityByChapterId.fromJson(Map<String, dynamic> json) => GetActivityByChapterId(
    status: json["status"],
