...
class _TypingDot extends StatefulWidget {
  ...
  _TypingDot({required this.dotColor, required this.dotSize, required this.duration});
...
class _TypingDotState extends State<_TypingDot> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return ScaleTransition(
      scale: Tween(begin: 1.0, end: 0.6).animate(CurvedAnimation(parent: _controller, curve: Curves.easeInOut)),
      child: Container(
