...
class _CharactersDetailsPageState extends State<CharactersDetailsPage> {
  ...
  fetchCharactersNyIdData() async {
    await ChatController.getCharactersById(widget.characterId).then(
      (value) {
        ChatController.chDetails.addAll((ChatController
                  ...
                  children: [
                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        //     ),
                        //     child: Text(
                        //       '${ChatController.calculatePercentage((double.tryParse((ChatController.getCharactersByIdModel.value.data?.totalReadChapter?.toDouble() ?? 0.0).toString()) ?? 0.0), (double.tryParse((ChatController.getCharactersByIdModel.value.data?.totalChapter?.toDouble() ?? 0.0).toString()) ?? 0.0)).toStringAsFixed(2)}%',
                    ...
                    2.ph,
                    if ((ChatController.chDetails.length ?? 0) > 0)
                      Wrap(
                    ...
                    ChatController
                        .getCharactersByIdModel.value.data?.introducation
                        .toString() ??
                    '',
                      style:
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: '1. Complete 3 Activities in this story : ',
                            style: AppTextStyle.normalRegular14
                    ...
                    2.ph,
                    if(ChatController
                        .getCharactersByIdModel.value.data != null)
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
