...
class ChatController {
  ...
  // static RxList<Map> characters = <Map>[
  ...
  // static RxList<Map> chatList = <Map>[
  //   {
  //     "image": "icons/chat",
  //     "heading": "Satoshi",
  //     "last": "Last message text Last message last mess .....",
  //     "time": "12:29 PM"
  //   },
  //   {
  //     "image": "icons/chat",
  //     "heading": "Kim Park Lee",
  //     "last": "Last message text Last message last mess .....",
  //     "time": "12:29 PM"
  //   },
  //   {
...
// bool _isGeneratingMessage = false;
  ...
  static String selectedReasons = "Select";
  ...
  static Rx<GetUnlockAllCharacters> getUnlockCharactersModel = GetUnlockAllCharacters().obs;
  ...
  static Rx<GetChatFromApiByCharacterId> getChatFromApiModel = GetChatFromApiByCharacterId().obs;
  ...
  static Future<bool> updateCharacterSummary(
