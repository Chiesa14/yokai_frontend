...
import 'package:yokai_quiz_app/screens/Create%20Account/controller/create_account_controller.dart';
...
class HomeController {
  // static RxList<Map> trending = <Map>[
  //    {"image": "icons/trending", "heading": "Mary’s Adventure"},
  //    {"image": "icons/trending", "heading": "Mary’s Adventure"},
  //    {"image": "icons/trending", "heading": "Mary’s Adventure"},
  //    {"image": "icons/trending", "heading": "Mary’s Adventure"}
  //  ].obs;
  static RxList<Map> explore = <Map>[
    {"image": "icons/explor", "heading": "Focus Challenge"},
    {"image": "icons/explor", "heading": "Focus Challenge"},
    {"image": "icons/explor", "heading": "Focus Challenge"},
    {"image": "icons/explor", "heading": "Focus Challenge"}
  ].obs;
  // static RxList<Map> left = <Map>[
  //    {"image": "icons/pickup", "heading": "Curious Cat in Na... ","ch": "CH.24"},
  //    {"image": "icons/pickup", "heading": "Curious Cat in Na... ","ch": "CH.3"},
  //    {"image": "icons/pickup", "heading": "Curious Cat in Na... ","ch": "CH.25"},
  //    {"image": "icons/pickup", "heading": "Curious Cat in Na... ","ch": "CH.13"}
  //  ].obs;
  // static RxList<Map> buddies = <Map>[
  //    {"image": "icons/buddies", "heading": "Nora"},
  //    {"image": "icons/buddies", "heading": "Nora"},
  //    {"image": "icons/buddies", "heading": "Nora"},
  //    {"image": "icons/buddies", "heading": "Nora"}
  //  ].obs;
  ...
  static Future<bool> recordDevice(String deviceId, String deviceName,String ipAddress) async {
    final headers = {
      "Content-Type": "application/json",
    };
