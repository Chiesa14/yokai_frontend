                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          'Hi ${(prefs.getString(LocalStorage.username) != null) ? prefs.getString(LocalStorage.username) : ''}${(prefs.getString(LocalStorage.username) != null) ? '!' : ''}',
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      shrinkWrap: true,
                      scrollDirection: Axis.horizontal,
                      itemCount: HomeController.explore.length,
                      itemBuilder: (context, index) {
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  Image.asset(
                                    '${HomeController.explore[index]['image']}.png',
                                    fit: BoxFit.fill,
                                  ...
                                  Align(
                                    child: Text(
                                      HomeController.explore[index]['heading'],
                                      style: AppTextStyle.normalBold12
