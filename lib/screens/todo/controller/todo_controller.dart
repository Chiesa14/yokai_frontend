...
class TodoController {
  static RxList<Map> todoList = <Map>[
    {
      "id": 1,
      "title": "Share App with 5 friends",
    ...
    {
      "id": 1,
      "title": "Share App with 10 friends",
    ...
    {
      "id": 1,
      "title": "Share App with 20 friends",
    ...
    {
      "id": 1,
      "title": "Share App with 50 friends",
      "badge": "Yokai",
      "isCompleted": 50,
      "isActive": 0,
      "type": "share"
    ...
    {
      "id": 1,
      "title": "Invite 1 friend to join challenge",
      "badge": "Yokai",
      "isCompleted": 1,
      "isActive": 0,
      "type": "invite"
    ...
    {
      "id": 1,
      "title": "Invite 10 friend to join challenge",
      "badge": "Yokai",
      "isCompleted": 10,
      "isActive": 0,
      "type": "invite"
