...
class _CongratulationPageState extends State<CongratulationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        nextPageOff(context, StartActivityPage(chapter: ReadController.chapterName.value, chapterId: ReadController.chapterId.value));
                        ...
                        children: [
                          ...
                          const Text(
                            ...
                            if ((ReadController.getActivityByChapterId.value
                                ...
                                3)
                              4.ph,
                            if((ReadController.getActivityByChapterId
                                .value.data?[0].readChapterCount ??
                                0) <
                                3)
                            SizedBox(
