...
class StartActivityPage extends StatefulWidget {
  ...
  StartActivityPage(
      {super.key, required this.chapter, required this.chapterId,this.storyName});
                    ...
                    Container(
                      ...
                      child: ((ReadController.getActivityByChapterId.value
                        ...
                        borderRadius: BorderRadius.circular(8),
                            ...
                            //   ),
                        CachedNetworkImage(
                          imageUrl: "${DatabaseApi.mainUrlImage}${ReadController.getActivityByChapterId.value.data?[0].activityImage.toString() ?? ''}",
                          ...
                          errorWidget: (context, url, error) => const Icon(Icons.error,color: AppColors.black,),
                          width: screenSize.width,
                          fit: BoxFit.fill,
                          // fit: BoxFit.contain,
                        ),
                          )
                          : const Center(child: Text('Photo Not Added')),
                      // Image.asset(
                        //   'icons/bear.png',
                        //   width: screenSize.width,
                        //   fit: BoxFit.fill,
