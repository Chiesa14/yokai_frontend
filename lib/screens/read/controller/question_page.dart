...
// import 'package:yokai_quiz_app/screens/chat/view/character_unlock_page.dart';
// import 'package:yokai_quiz_app/screens/read/controller/read_controller.dart';
// import 'package:yokai_quiz_app/screens/read/view/audio_ui.dart';
...
//                                             optionColor = ansIndex.isNotEmpty &&
...
//                                         Text(
//                                           'Explanation : ${ReadController.decodeApiString(hexString: ReadController.getActivityByChapterId.value.data?[0].details?[index].explation.toString() ?? '')}',
//                                         style: AppTextStyle.normalSemiBold13
//                                             .copyWith(color: queGrey),
//                                       ),
//                                     if (ReadController
//                                         .isStampImageAndAudio.isTrue)
//                                       Column(
//                                         children: [
//                                           if (((ReadController
//                                               .getActivityByChapterId
...
//                                                           .isStampImageAndAudio(
//                                                               true);
//                                                     } else if (unlockedCharacterStatus ==
//                                                             'yes' &&
//                                                         readStatus == 'yes') {
//                                                       if (ReadController
//                                                           .isStampImageAndAudio
...
//                                                   }
//                                                 } else {
//                                                   customPrint('Please Select One Option');
//                                                   showErrorMessage(
//                                                       'Please Select One Option',errorColor);
//                                                 }
//                                               } else {
//                                                 if (isExplanation[index] ==
//                                                     false) {
                                              ...
                                              if (widget.reviewTest != true) {
                                                if (index !=
                                                  ...
                                                  if (isExplanation[index] ==
                                                    ...
                                                    //     '') ==
                                                    //     'yes') {
                                                    String? audio = ReadController.getActivityByChapterId.value.data?[0].audio?.toString();
                                                    String? image = ReadController.getActivityByChapterId.value.data?[0].image?.toString();
                                                    customPrint(
                                                        "audio :: $audio");
                                                    customPrint(
                                                        "image :: $image");
                                                ...
                                                if (isExplanation[index] ==
                                                  ...
                                                  if (index !=
                                                    ...
                                                    if ((audio == "null" || audio!.isEmpty) && (image == "null" || image!.isEmpty)) {
                                                      nextPage(
                                                        CongratulationPage(
                                                          length: ReadController.getActivityByChapterId.value.data?[0].details?.length?.toString() ?? '',
                                                          score: score.toString(),
                                                        ),
                                                      );
                                                    } else {
